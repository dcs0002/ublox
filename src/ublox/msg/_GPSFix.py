"""autogenerated by genpy from ublox/GPSFix.msg. Do not edit."""
import sys
...
class GPSFix(genpy.Message):
  _md5sum = "94be19198c09782b28b0ad3ca080ec53"
  _type = "ublox/GPSFix"
...
"""
  __slots__ = ['header','time','pdop','ecefX','ecefY','ecefZ','ecefVX','ecefVY','ecefVZ']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,time,pdop,ecefX,ecefY,ecefZ,ecefVX,ecefVY,ecefVZ
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_8d.pack(_x.time, _x.pdop, _x.ecefX, _x.ecefY, _x.ecefZ, _x.ecefVX, _x.ecefVY, _x.ecefVZ))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time, _x.pdop, _x.ecefX, _x.ecefY, _x.ecefZ, _x.ecefVX, _x.ecefVY, _x.ecefVZ,) = _struct_8d.unpack(str[start:end])
      return self
