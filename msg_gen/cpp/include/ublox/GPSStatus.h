/* Auto-generated by genmsg_cpp for file /home/cody/Development/DR_ws/ublox/msg/GPSStatus.msg */
#ifndef UBLOX_MESSAGE_GPSSTATUS_H
#define UBLOX_MESSAGE_GPSSTATUS_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct GPSStatus_ {
  ...
  typedef boost::shared_ptr< ::ublox::GPSStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ublox::GPSStatus_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GPSStatus
typedef  ::ublox::GPSStatus_<std::allocator<void> > GPSStatus;

typedef boost::shared_ptr< ::ublox::GPSStatus> GPSStatusPtr;
typedef boost::shared_ptr< ::ublox::GPSStatus const> GPSStatusConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::ublox::GPSStatus_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::ublox::GPSStatus_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::ublox::GPSStatus_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::ublox::GPSStatus_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::ublox::GPSStatus_<ContainerAllocator> > {
  static const char* value() 
  {
    return "313baa8951fdd056c78bf61b1b07d249";
  }

  static const char* value(const  ::ublox::GPSStatus_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x313baa8951fdd056ULL;
  static const uint64_t static_value2 = 0xc78bf61b1b07d249ULL;
};

template<class ContainerAllocator>
struct DataType< ::ublox::GPSStatus_<ContainerAllocator> > {
  static const char* value() 
  {
    return "ublox/GPSStatus";
  }
...
template<class ContainerAllocator>
struct Definition< ::ublox::GPSStatus_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::ublox::GPSStatus_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::ublox::GPSStatus_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::ublox::GPSStatus_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::ublox::GPSStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::ublox::GPSStatus_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // UBLOX_MESSAGE_GPSSTATUS_H
